...
public class JasmineTestRunner extends Runner {
    ...
    private RhinoContext setUpRhinoScope() {
        ...
        context.loadFromClasspath(suiteAnnotation.sourcesRootDir(), suiteAnnotation.sources());
        context.loadFromClasspath(suiteAnnotation.jsRootDir() + "/specs", getJasmineSpecs(suiteAnnotation));
