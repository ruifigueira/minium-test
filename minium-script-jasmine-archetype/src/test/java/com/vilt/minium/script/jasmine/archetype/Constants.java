 ...
 */
package com.vilt.minium.script.jasmine.archetype;
...
public class Constants {
    ...
    public static final String TEST_SPEC_NAME = "test_my_archetype";
    ...
    public static Properties getSystemProperties() {
        ...
        props.put("archetypeArtifactId", Constants.ARCHETYPE_ARTIFACT_ID);
        ...
        props.put("specName", Constants.TEST_SPEC_NAME);
